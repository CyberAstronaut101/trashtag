...
router.post("/createMachine", checkAuth, (req, res, next) => {
    console.log("POST@/api/printerQueue/creteMachine"); 
    ...
    newMachine.save()
        .then(createdMachine => {
            ...
            let returnMessage = {
                severity: 'success',
                summary: 'Success',
                detail: 'machine save to db successful!'
            }
        ...
        .catch(err => {
            ...
            let returnMessage = {
                severity: 'error',
                summary: 'Error',
                detail: 'machine save to db failed!'
            }
...
router.post("/createCurrentPrintJob", checkAuth, (req, res, next) => {
    ...
    newPrintQueueItem.save()
        .then(createdPrintJob => {
            ...
            // resObject.returnMessage.push(returnMessage);
            ...
            // update the printerMachine currentJobID with this new job id
                printerMachine.findOneAndUpdate(
                    ...
                    .catch(err => {
                        console.log("No users found with is")
                    })
            ...
            .catch(err => {
                ...
                resObject.serverMessage.push(returnMessage);
            })
            
            console.log(" $$$$$ ON CREATE NEW CURRENT PRINTER JOB $$$$$");
            return res.status(200).json(resObject);
})
                                        ...
                                        .then(currentPrintHistory => {
                                            ...
                                            .then(currentPrinterPrintQueue => {
                                                    ...
                                                    if(activePrintQueueItems.length > 0) {
                                                        ...
                                                        // there are no queue items for the printer, do nothing
                                                        // send message back and whatnot
                                                        let retMessage = {
                                                            severity: 'success',
